...
class RetrieveDamageWidget extends StatefulWidget {
  const RetrieveDamageWidget({super.key, required this.onComplete, required this.step});
  final Function(bool) onComplete;
  final Steps? step;

  @override
  State<RetrieveDamageWidget> createState() => _RetrieveDamageWidgetState();
}

class _RetrieveDamageWidgetState extends State<RetrieveDamageWidget> {
