...
class HandoverCarDetailsWidget extends StatelessWidget {
  const HandoverCarDetailsWidget({super.key, required this.taskModel});
        ...
        children: [
          ...
          BorderCardTile(
            ...
            title: taskModel?.task?.type == TaskTypeEnum.pickUp.value
                ? taskModel?.task?.locationName ?? '${locale?.notAvailable}'
                : taskModel?.task?.deliveryAddress ?? '${locale?.notAvailable}',
            subTitle:
