...
import '../widgets/handover_car_details_widget.dart';
...
class _HandoverState extends State<Handover> {
  late HandoverController controller;
  late int? taskId;
  bool showStep = false;
  ...
  Widget _bodyUI(HandoverController controller, AppLocalizations? locale) => ListRefreshIndicator(
        ...
        child: ListView(
          ...
          children: [
            // Car details widget
            HandoverCarDetailsWidget(taskModel: controller.taskModel.value),
              ...
              child: Column(
                ...
                children: [
                  ...
                  showStep == false
                      ...
                      : Obx(
                          () => controller.taskModel.value?.task?.steps != null && showStep == true
                              ? ListView.separated(
                                  shrinkWrap: true,
