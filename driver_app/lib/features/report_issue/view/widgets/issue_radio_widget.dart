...
class IssueRadioWidget extends StatefulWidget {
  final List<IssueModel> issueList;
  final ValueChanged<IssueModel> onChanged;

  const IssueRadioWidget({
    super.key,
  ...
  @override
  State<IssueRadioWidget> createState() => _IssueRadioWidgetState();
}

class _IssueRadioWidgetState extends State<IssueRadioWidget> {
