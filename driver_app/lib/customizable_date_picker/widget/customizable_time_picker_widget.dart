...
import '../consts/semantic_labels.dart';
import '../i18n/date_picker_i18n.dart';
import '../model/date_picker_constants.dart';
import '../model/date_picker_theme.dart';
import '../model/date_time_formatter.dart';
import 'date_picker_divider_widget.dart';
...
class CustomizableTimePickerWidget extends StatefulWidget {
  ...
  @override
  State<CustomizableTimePickerWidget> createState() =>
      _CustomizableTimePickerWidgetState();
}

class _CustomizableTimePickerWidgetState
    extends State<CustomizableTimePickerWidget> {
  ...
  void initState() {
    ...
    _hoursScrollCtrl =
        FixedExtentScrollController(initialItem: _startingDate.hour);

    _minutesScrollCtrl =
        FixedExtentScrollController(initialItem: _startingDate.minute);

    _secondsScrollCtrl =
        FixedExtentScrollController(initialItem: _startingDate.second);
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      child:
          Material(color: Colors.transparent, child: _renderTimePickerWidget()),
    );
  }
    ...
    return Container(
        ...
        child: AutoSizeText(
          DateTimeFormatter.formatDateTime(
              value, format, widget.locale, _startingDate.weekday),
  ...
  void _onSelectedChange() {
    if (widget.onChange != null) {
      DateTime dateTime = DateTime(_startingDate.year, _startingDate.month,
          _startingDate.day, _currentHour, _currentMinute, _currentSecond);
