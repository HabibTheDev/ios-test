...
import '../helpers/range_helper.dart';
...
class _CustomizableDatePickerWidgetState
    extends State<CustomizableDatePickerWidget> {
  ...
  void initState() {
    ...
    _currentYear =
        min(max(_minDateTime.year, _currentYear!), _maxDateTime.year);

    _monthRange = RangeHelper.calculateMonthRange(
        _minDateTime, _maxDateTime, _currentYear);
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      child:
          Material(color: Colors.transparent, child: _renderDatePickerWidget()),
    );
  }
